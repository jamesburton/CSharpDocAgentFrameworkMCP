# Requirements Archive: v1.3 Housekeeping
...
- [x] **QUAL-01**: Stale "TODO: replace with BM25" comment removed from InMemorySearchIndex.cs
- [x] **QUAL-02**: Stale "stub" comment removed from KnowledgeQueryService.cs:215
- [x] **QUAL-03**: v1.2 audit artifact issues resolved (stale frontmatter, documentation gaps)
